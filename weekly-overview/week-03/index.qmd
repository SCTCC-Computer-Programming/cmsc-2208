---
title: "Week 3 Guide"
subtitle: "Chapter 2 — Linear Models for Regression and Classification"
format:
  html:
    toc: true
---
...
- Penalizes the **sum of squared coefficients**: w₁² + w₂² + w₃² + ...
...
- Penalizes the **sum of absolute values**: |w₁| + |w₂| + |w₃| + ...
